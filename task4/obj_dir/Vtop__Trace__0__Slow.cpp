...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,"bcd", false,-1, 11,0);
    ...
    tracep->declBus(c+4,"BCD", false,-1, 11,0);
    tracep->declBus(c+6,"result", false,-1, 19,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullSData(oldp+4,(vlSelf->bcd),12);
    bufp->fullCData(oldp+5,(vlSelf->top__DOT__count),8);
    bufp->fullIData(oldp+6,(vlSelf->top__DOT__myDecoder__DOT__result),20);
