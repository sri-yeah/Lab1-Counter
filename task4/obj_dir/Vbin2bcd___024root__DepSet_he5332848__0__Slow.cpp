...
VL_ATTR_COLD void Vbin2bcd___024root___eval_static(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___eval_static\n"); );
}
...
VL_ATTR_COLD void Vbin2bcd___024root___eval_final(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___eval_final\n"); );
}
...
#endif  // VL_DEBUG
VL_ATTR_COLD void Vbin2bcd___024root___eval_stl(Vbin2bcd___024root* vlSelf);
...
VL_ATTR_COLD void Vbin2bcd___024root___eval_settle(Vbin2bcd___024root* vlSelf) {
    ...
    while (__VstlContinue) {
        __VstlContinue = 0U;
        Vbin2bcd___024root___eval_triggers__stl(vlSelf);
...
#endif
                VL_FATAL_MT("bin2bcd.sv", 14, "", "Settle region did not converge.");
            }
            vlSelf->__VstlIterCount = ((IData)(1U) 
                                       + vlSelf->__VstlIterCount);
            Vbin2bcd___024root___eval_stl(vlSelf);
        }
    }
}
...
VL_ATTR_COLD void Vbin2bcd___024root___dump_triggers__stl(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___dump_triggers__stl\n"); );
    // Body
...
void Vbin2bcd___024root___ico_sequent__TOP__0(Vbin2bcd___024root* vlSelf);

VL_ATTR_COLD void Vbin2bcd___024root___eval_stl(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___eval_stl\n"); );
    // Body
    if ((1ULL & vlSelf->__VstlTriggered.word(0U))) {
...
VL_ATTR_COLD void Vbin2bcd___024root___dump_triggers__ico(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___dump_triggers__ico\n"); );
    // Body
...
VL_ATTR_COLD void Vbin2bcd___024root___dump_triggers__act(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___dump_triggers__act\n"); );
    // Body
...
VL_ATTR_COLD void Vbin2bcd___024root___dump_triggers__nba(Vbin2bcd___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vbin2bcd__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vbin2bcd___024root___dump_triggers__nba\n"); );
    // Body
